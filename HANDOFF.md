...
- Current verified gates: 104 integrated site tests, 31 tournament-engine tests and the complete 30-migration PGlite/RLS/privilege chain pass; the protected import passes exact operational counts.
