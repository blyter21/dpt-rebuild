...
- Real staging tournament operations exist for player registration, check-in, registration open/close, add-ons/rebuys, DPT/freeroll elimination, payout materialization, undo/correction and audit logging.
...
- Current verified gates: 48 integrated site tests, 31 tournament-engine tests and the complete 20-migration PGlite/RLS/privilege chain pass; the payout-aware protected import also passes exact embedded-Postgres counts.
...
- Remaining tournament workflows: satellite winners, flight advancement, bulk rank editing and full reset.
