...
def main() -> None:
    ...
    entity_specs = [
        ...
        ('dpt_seasons','seasons',['id','league_id','name','alias','description','is_default','logo_url','banner_url','start_at','end_at','status','created_at','updated_at','deleted_at','legacy_data'],
         lambda r:[integer(r['id']),integer(r.get('league_id')) or None,clean_text(r.get('name')),clean_text(r.get('alias')),clean_text(r.get('description')),truthy(r.get('default')),clean_text(r.get('logo')),clean_text(r.get('banner_image')),clean_date(r.get('start_date')),clean_date(r.get('end_date')),truthy(r.get('status')),clean_date(r.get('created_at')),clean_date(r.get('updated_at')),clean_date(r.get('deleted_at')),r]),
        ('dpt_venues','venues',['id','name','alias','address','city','state','zip','phone','website','latitude','longitude','logo_url','banner_url','facebook_url','twitter_url','instagram_url','youtube_url','map_location_address','status','created_at','updated_at','deleted_at','legacy_data'],
         lambda r:[integer(r['id']),clean_text(r.get('name')),clean_text(r.get('alias')),clean_text(r.get('address')),clean_text(r.get('city')),clean_text(r.get('state')),clean_text(r.get('zip')),clean_text(r.get('phone')),clean_text(r.get('website')),number(r.get('map_location_latitude')) or None,number(r.get('map_location_longitude')) or None,clean_text(r.get('logo')),clean_text(r.get('banner_image')),clean_text(r.get('fb_url')),clean_text(r.get('twitter_url')),clean_text(r.get('instagram_url')),clean_text(r.get('youtube_url')),clean_text(r.get('map_location_address')),truthy(r.get('status')),clean_date(r.get('created_at')),clean_date(r.get('updated_at')),clean_date(r.get('deleted_at')),r]),
        ('dpt_events','events',['id','season_id','venue_id','name','alias','description','start_at','end_at','status','rules_description','logo_url','banner_url','facebook_event_url','created_at','updated_at','deleted_at','legacy_data'],
         lambda r:[integer(r['id']),integer(r.get('season_id')) or None,integer(r.get('venue_id')) or None,clean_text(r.get('name')),clean_text(r.get('alias')),clean_text(r.get('description')),clean_date(r.get('start_date')),clean_date(r.get('end_date')),truthy(r.get('status')),clean_text(r.get('rules_description')),clean_text(r.get('logo')),clean_text(r.get('banner_image')),clean_text(r.get('fb_event_url')),clean_date(r.get('created_at')),clean_date(r.get('updated_at')),clean_date(r.get('deleted_at')),r]),
    ]
