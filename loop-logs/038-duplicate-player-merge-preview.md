# Loop 038 — Duplicate Player Merge Preview

## Goal

Expanded Players module with mock duplicate-player merge review, primary/secondary account notes, tournament-history transfer preview, and disabled merge.
