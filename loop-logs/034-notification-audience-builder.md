# Loop 034 — Notification Audience Builder

## Goal

Added mock-only Events/Tournaments/Venues/Players audience builder for email, SMS, and internal notifications; send remains disabled.
